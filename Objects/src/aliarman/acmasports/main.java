...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "aliarman.acmasports", "aliarman.acmasports.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "aliarman.acmasports", "aliarman.acmasports.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "aliarman.acmasports.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public aliarman.acmasports.starter _starter = null;
...
_p = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 31;BA.debugLine="Dim Response, Error As StringBuilder";
...
_error = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Response.Initialize";
_response.Initialize();
 //BA.debugLineNum = 33;BA.debugLine="Error.Initialize";
_error.Initialize();
 //BA.debugLineNum = 34;BA.debugLine="p.Shell(\"ping -c 1 8.8.8.8\",Null,Response,Error)";
_p.Shell("ping -c 1 8.8.8.8",(String[])(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(_response.getObject()),(java.lang.StringBuilder)(_error.getObject()));
 //BA.debugLineNum = 35;BA.debugLine="If Error.ToString=\"\" And Response.ToString.Contai";
if ((_error.ToString()).equals("") && _response.ToString().contains("Destination Host Unreachable")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 36;BA.debugLine="WebView1.LoadUrl(\"https://kifonlinetak.ir/\")";
mostCurrent._webview1.LoadUrl("https://kifonlinetak.ir/");
 }else {
 //BA.debugLineNum = 38;BA.debugLine="ToastMessageShow(\"ارتباط با اینترنت برقرار نیست!";
